...
<%
    ...
    if(i==1){
//    	out.write("Piechart created Successfully.....");
    }
    else{
  //  	out.write("Piechart creation is Failed...");
    }
    %>
...
<script type='text/javascript'></script>
  ...
  <div class="col_w900 col_w900_last">
   <div align="center"> <input name="imageField" type="image" src="images/PiechartPNG/piechart.jpg" width="400" height="400"/></div>
  </div>
  </div>
