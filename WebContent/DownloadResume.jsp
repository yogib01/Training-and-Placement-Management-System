...
<script type='text/javascript'></script>
 ...
 <form action="DownloadFile.com" method="get">

  <div align="center"><select name="uname">
 <% Connection con=DBConnection.getConnection();
 		Statement stmt=con.createStatement();
 		ResultSet rs=stmt.executeQuery("select uname from StudentBasicInfo");
 		while(rs.next()){
 %>
 ...
 <input type="submit" value="Download Resume"></input></div>
