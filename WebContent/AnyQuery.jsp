...
<title>Carrier Click |Any Query</title>
...
<script type='text/javascript'></script>
  ...
  <fieldset><legend>Send Mail To Student or Company-Recruiter</legend>
  <form name="form2" id="form2" method="post" action="sendMailAction.jsp">
    <table width="436" border="1" align="center">
      <tr bgcolor ="#E9E9D8">
        <td width="149" height="91">Recipients Email ID: </td>
        <td width="271">
      ...
      <tr bgcolor ="#E9E9D8">
        <td height="102">Body : </td>
        <td><textarea name="textarea"></textarea></td>
      </tr>
      <tr bgcolor="#FEF7E9">
        <td height="69">Sender Email ID :</td>
        <td><input type="text" name="textfield" /></td>
      </tr>
      <tr bgcolor ="#E9E9D8">
        <td height="56">Sender Password : </td>
	  ...
	  <tr bgcolor ="#E9E9D8" ><td height="40" colspan="2">
