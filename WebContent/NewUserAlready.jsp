    ...
    <div class="col_w900 col_w900_last">
          <div class="col_w420 float_l">
            ...
            <div class="col_w420 float_r">
              ...
              <table width="307" height="241" >
  <tr>
    <td width="124" height="40"><div align="left">Enter User Name : </div></td>
    <td width="171">
      <input type="text" name="uname" onkeypress="return uname1()" />
    
      </td>
  </tr>
  <tr><td></td><td><span class="style2">Username is already exists???? </span></td></tr>
  <tr>
