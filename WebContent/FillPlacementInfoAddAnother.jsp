     ...
     <div id="templatemo_menu">
        ...
        <div id="search_box">
            <form  action="#" method="post">
              <font color="#FFCC00"> Welcome <%=session.getAttribute("uname")%></font>(this)" value="Search" size="10" maxlength="60" />
            </form>
        </div>
...
<tr><td colspan="2"><div align="center" >Record Inserted Successfully!!!!!!!  Add Another .........</div></td></tr>
