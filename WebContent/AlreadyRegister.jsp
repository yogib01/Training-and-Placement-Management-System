...
<title>Carrier Click|Already Register</title>
...
<input type="hidden" name="uname" id="uname" value="<%=session.getAttribute("uname")%>">
	<p align="center"><font color="red">You Are Alredy Registered Your Personal Information !!!!!!!!!</font> </p><br>
	<p align="center">	Please Goto Profile Menu If You Want To Update Your Personal Information.....</p>
</form>
