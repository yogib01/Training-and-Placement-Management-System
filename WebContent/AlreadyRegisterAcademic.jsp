...
<title>Carrier Click|Already Register Academic</title>
...
<input type="hidden" name="uname" id="uname" value="<%=session.getAttribute("uname")%>">
	<p align="center"><font color="red">You Are Alredy Registered Your Academic Information !!</font> </p><br>
	<p align="center">	Please Goto Profile Menu If You Want To Update Your Academic Information.....</p>
</form>
