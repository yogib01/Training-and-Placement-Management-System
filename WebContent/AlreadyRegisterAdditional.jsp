...
<title>Carrier Click|Already Register Add. Info</title>
...
<input type="hidden" name="uname" id="uname" value="<%=session.getAttribute("uname")%>">
	<p align="center"><font color="red">You Are Already Registered Your Other Information !!!!!!!!!</font> </p><br>
	<p align="center">	Please Goto Profile Menu If You Want To Update Your Other Information.....</p>
</form>
