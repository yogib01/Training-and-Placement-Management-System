...
function faggregate()
{
	...
	if(academicyear=="Third"){
			...
			var temp=document.cal.fe1.value;
			var temp2=document.cal.fe2.value;
			alert(temp);
			alert(temp2);
...
<script type='text/javascript'></script>
  ...
  <div class="col_w900 col_w900_last">
   <form name="cal" action="academicInfoAction1.jsp" method="post">
<fieldset>
...
<table width="584" border="0" align="center" >
  ...
  <tr bgcolor ="#E9E9D8">
    ...
    <td width="179"><input name="admission_year" type="text" id="admission_year" onchange="return ayear()" onblur="return admissionValidate()"/></td>
    <td width="104"><div align="center">Current year </div></td>
    <td width="179"><input name="current_year" type="text" id="current_year" onchange="return cyear()" onblur="return currentValidate()" onkeypress="return currentValidate()"/></td>
  </tr>
  <tr bgcolor="#FEF7E9">
...
<tr bgcolor ="#E9E9D8">
	...
	<td><input type="text" name="college" id="college" onblur="return cname()" onkeypress="return cname()"/></td><td colspan="2"></td>
</tr>
</table>
</fieldset>
&nbsp;
...
<table width="584" border=0" align="center">
  <tr bgcolor ="#E9E9D8">
    ...
    <td width="145"><input name="ssc" type="text" id="ssc" onkeypress="return ssc1()" onblur="return ssc1()"/></td>
    <td width="109"><div align="center">HSC</div></td>
    <td width="182"><input name="hsc" type="text" id="hsc" onkeypress="return hsc1()" onblur="return hsc1()"/></td>
    </tr>
  <tr>
  ...
  <tr bgcolor ="#E9E9D8">
    ...
    <td><input name="fe1" type="text" id="result" onkeypress="return fejs1()" onblur="return fejs1()"/></td>
    <td><div align="center">FEII</div></td>
    <td><input name="fe2" type="text" id="result1" onkeypress="return fejs2()" onblur="return fejs2()"/></td>
    </tr>
  <tr bgcolor="#FEF7E9">
    <td height="43"><div align="center">SEI</div></td>
    <td><input name="se1" type="text" id="se1" onkeypress="return sejs1()" onblur="return sejs1()" /></td>
    <td><div align="center">SEII</div></td>
    <td><input name="se2" type="text" id="se2" onkeypress="return sejs2()" onblur="return sejs2()"/></td>
  </tr>
  <tr bgcolor ="#E9E9D8">
    <td height="47"><div align="center">TEI</div></td>
    <td><input name="te1" type="text" id="te1" onkeypress="return tejs1()" onblur="return tejs1()"/></td>
    <td><div align="center">TEII</div></td>
    <td><input name="te2" type="text" id="te2" onkeypress="return tejs2()" onblur="return tejs2()"/></td>
  </tr>
  <tr bgcolor="#FEF7E9">
    <td height="40"><div align="center">BEI</div></td>
    <td><input name="be1" type="text" id="be1" onkeypress="return bejs1()" onblur="return bejs1()"/></td>
    <td><div align="center">BEII</div></td>
    <td><input name="be2" type="text" id="be2" onkeypress="return bejs2()" onblur="return bejs2()"/></td>
  </tr>
  <tr bgcolor ="#E9E9D8">
    
    <td height="39"><div align="center">Aggregate</div></td>
    <td><input name="aggregate" type="text" id="txtresult" onfocus="return faggregate()"/></td>
    <td height="39">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
   <tr bgcolor="#FEF7E9">
    <td height="37"><div align="center">Live Backlogs</div></td>
    <td><input name="lback" type="text" id="lback" onkeypress="return lb()"  onblur="return lb()" /></td>
    <td><div align="center">Dead Backlogs </div></td>
    <td><input name="dback" type="text" id="dback" onkeypress="return db()" onblur="return db()"/></td>
  </tr>
</table>
</fieldset>
