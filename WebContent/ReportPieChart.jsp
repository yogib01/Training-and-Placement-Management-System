...
<title>Carrier Click |Report Piechart</title>
...
<script type='text/javascript'></script>
  ...
  <div class="col_w900 col_w900_last">
    <form name="form1" id="form1" method="post" action="PieChartAction.jsp">
      <a href="PieChartAction.jsp" style="text-decoration: none">View Piechart</a>
    </form>
