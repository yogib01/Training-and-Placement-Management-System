...
<title>Carrier Click|Download Placement Papers</title>
...
<form action="DownloadCriteriaList.com" method="get">
  <input type="hidden" name="file" value="L&T1.pdf">
 
  <input type="submit" value="Download L&T Paper"></input>

  <form action="DownloadCriteriaList.com" method="get">
  <input type="hidden" name="file" value="LogicalReasoning.pdf">
  
  <input type="submit" value="Download Logical Reasoning Paper"></input>
